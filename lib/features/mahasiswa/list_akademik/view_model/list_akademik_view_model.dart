...
class ListAkademikViewModel {
  final listAkademikItems = [
    ...
    KotakFiturWarnaWarniModel1(
      ...
      nextRoute: MyPensNavRoutes.mahasiswaUrusAbsensiAlpha,
    ),
    KotakFiturWarnaWarniModel1(
      judul: 'Upload Nilai MBKM',
      warnaKotak: const Color(0xff1b7742),
      nextRoute: MyPensNavRoutes.mahasiswaUploadNilaiMBKM,
    ),
    KotakFiturWarnaWarniModel1(
      judul: 'Entry Logbook MBKM',
      warnaKotak: const Color(0xff1b7742),
      nextRoute: MyPensNavRoutes.entryLogbook,
    ),
  ];
}
